  ...
  $.verify.addFieldRules({
    ...
    required: {
      ...
      messages: {
        ...
        "single": "Esta opción es requerida"
      }
    },
    regex: {
      fn: function(r) {
...
$.verify.addRules({
          ...
          if(Name.length > 1){ 
             for(i=0; i< Name.length; i++){
                ...
                if(!((namechar>='a' && namechar <='z') 
                        ...
                        (namechar=='.') || (namechar==' ') ) ) {
                    return namechar +" no está permitido en este campo";
                }
             }
          }else{
            return "Por favor escriba correctamente la información"; 
            }
          return true;
        },
          ...
          if(Mobile.length == 10){
                    for(i=0; i<Mobile.length; i++){
                       ...
                       if(!(mobilechar>='0' && mobilechar<='9')){
                          return  mobilechar+" no permitido !";
                       }
                    }
                }else{
                  return "Por favor escribe un número correcto";
                }
          return true;
        },
        ...
        var Email = r.val();
        if(Email.length < 10){
          return "Por favor escribar un correo electrónico correcto";
      }
      flag=0;
    for(i=0;i<Email.length;i++){
      ...
      if(y==32){
              return "los espacios no son permitidos en el correo";
          }
          if(y==64){
              flag=flag+1;
          }
          if(y==46){
            ...
            if(flag >= 2){
             ...
             return"Por favor ingrese una dirección de correo correcta";
            }
          },
      ...
      percentage : function(r){
          if(isNaN(parseInt(r.val()))){
              return "Por favor escriba el porcentaje correcto de 0 a 100 ";
          }
          ...
          if(AlphaNumber.length > 1){ 
             for(i=0; i< AlphaNumber.length; i++){
                ...
                if(!((alphachar>='a' && alphachar <='z') 
                    ...
                    if(alphachar == ' '){
                        return " no se permite espacio en este campo";
                    }
                    return alphachar +" no está permitido en este campo";
                }
             }
          }else{
            return "Por favor escriba la información correcta"; 
            }
          return true;
        }
    });
    ...
    function confirmMyPassword(pass,confpass){
        if(pass.length > 7 && confpass.length > 7){
            if(pass!=confpass){
               return "contraseña y confirmar contraseña no coincidente"; 
            }else{
                return true;
            }
        }else{
            return "la longitud mínima debe ser de 8 caracteres";
        }
    }