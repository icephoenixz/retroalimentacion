                ...
                <div class="row">
                    <div class="col-md-6 col-xs-12">
                        <div class="welcome-section">
                                <h4 class="text-center"> Información del Profesor </h4> 
                                ...
                                <form  enctype="multipart/form-data" method="post">
                                    ...
                                    <div class="col-md-12 col-xs-12">
                                     ...
                                     <div class="col-md-12 col-xs-12">
                                        <div class="form-group">
                                            <input type="text" name="designation"  class="form-control" placeholder="Ingresa tu designación" data-validate="required" >
                                        </div>
                                    </div>
                                     <div class="col-md-12 col-xs-12">
                                        <div class="form-group">
                                            <input type="text" name="specification"  class="form-control" placeholder="Ingresa tu especialidad" data-validate="required" >
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-xs-12">
                                        <div class="form-group">
                                            <button type="submit" name="addstudent" class="btn btn-primary" id="addProfessor"><strong>Enviar</strong></button>
                                        </div>
                                    </div>
                            </form>
                        </div>
