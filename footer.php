    ...
    <footer class="style-1" style="margin-top: 0px;background: rgba(0, 0, 0, 0.9);">
            <div class="container">
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <span class="copyright">Traido a ti con gusto por &copy; <a href="https://www.configuroweb.com/">ConfiguroWeb</a> 2020</span>
                    </div>
                    <div class="col-md-4 col-xs-12">
